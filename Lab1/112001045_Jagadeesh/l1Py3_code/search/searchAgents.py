...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state: Any):
        ...
        if list(state[1])==[True,True,True,True]:
            return True
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if hitsWall==False:
                ...
                if (nextx,nexty) in self.corners:
                    corners_list[self.corners.index((nextx,nexty))]=True
                    
                new_state = ((nextx, nexty),corners_list) # Fix new state
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    if problem.isGoalState(state):
        ...
        corners_statuses=list(state[1])
        for item in corners_statuses:
            if item == False: # Not visited corner
                # Use manhattan method #
                distances.append(manhattanDistance(state[0],corners[corners_statuses.index(item)]))
